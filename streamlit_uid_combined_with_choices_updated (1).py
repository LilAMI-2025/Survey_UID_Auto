...
HEADING_REFERENCES = [
    ...
    "Thank you for taking the time to reflect on how aligned your learning initiatives are with your key strategic priorities. Once you submit, we will review your responses (alongside those of your CEO, people lead, senior managers) in order to advise on the most effective learning programme(s) for your organisation.",
    ...
    "As a last step, we ask that you rank order the short list of those you have indicated are both important and less frequent for managers. In that way, you will tell us the priority behaviours you would like us to encourage your managers to demonstrate. You can either drag and drop the Winning behaviours into your chosen rank position, or you can adjust their numbering manually.",
